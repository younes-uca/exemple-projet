...
@Component({
  selector: 'app-commande-view-chercheur',
  templateUrl: './commande-view-chercheur.component.html',
  styleUrls: ['./commande-view-chercheur.component.css']
})
export class CommandeViewChercheurComponent implements OnInit {
